                ...
                <div className="lg:flex lg:items-start lg:gap-8">
                    ...
                    <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                        <div className="col-span-2">
                            <div>
                                <h2 className="text-2xl font-semibold font-monserrat text-customBlue mt-3">¡Regístrate y recibe las mejores ofertas!</h2>
                        ...
                        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                            <form className="w-full">
                                ...
                                >
                                    ...
                                    <button
                                        className="mt-1 w-full bg-orange-500 px-6 py-3 text-sm font-semibold font-monserrat  tracking-wide text-white transition-none hover:bg-yellow-400 sm:mt-0 sm:w-auto sm:shrink-0"
                                    >
                                        Suscribirme
                                    </button>
                                </div>
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <p className=" text-customBlue font-semibold font-monserrat ">Servicio al cliente</p>
